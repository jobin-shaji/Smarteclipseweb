<ul class="navbar-nav float-left mr-auto">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="{{url('/device-service')}}"> SERVICES</a>
            <a class="dropdown-item" href="{{url('/devicein')}}">DEVICE IN</a>
            <a class="dropdown-item" href="{{url('/deliveredview')}}">DEVICE OUT</a>
            <a class="dropdown-item" href="{{url('/commands-center')}}"> COMMANDS SENDER </a>
