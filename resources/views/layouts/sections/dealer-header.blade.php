                       ...
                       <!--  <li class="nav-item search-box"> 
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{url('/sos-dealer')}}"> IN STOCK</a>  
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{url('/online-device-report')}}">DEVICE ONLINE REPORT<span></span></a>
                                <a class="dropdown-item" href="{{url('/offline-device-report')}}">DEVICE OFFLINE REPORT<span></span></a>
                            </div>
                        </li>
                    </ul>