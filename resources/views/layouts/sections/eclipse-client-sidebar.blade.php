                ...
                <ul class="navbar-menu animate">
                  ...
                  <li>
                    <a href="{{url('/tracking-report')}}" class="animate">
                      ...
                      <span class=""><img src="{{ url('/') }}/Report-icons/tracking-report.png"  /></span>
                  ...
                  <li>
                    <a href="{{url('/over-speed-report')}}" class="animate">
                      ...
                      <span class=""><img src="{{ url('/') }}/Report-icons/overspeed-report.png"  /></span>
                    </a>
                  </li>
                  <li>
                    <a href="{{url('/zigzag-driving-report')}}" class="animate">
                      <span class="desc animate"> Zig-Zag Driving Report</span>
                      <span class=""><img src="{{ url('/') }}/Report-icons/zigzag-report.png"  /></span>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="{{url('/mainbattery-disconnect-report')}}" class="animate">
                      ...
                      <span class=""><img src="{{ url('/') }}/Report-icons/main-battery-disconnect-report.png"  /></span>
                    </a>
                  </li>
