...
<body  style="background-image: url({{ url('/') }}/assets/images/loginbg.jpg);height: 100vh;background-repeat: no-repeat;background-position: center;background-size: cover;">
    <div id="app" >
