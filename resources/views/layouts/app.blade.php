...
<body  style="background-image: url({{ url('/') }}/assets/images/loginbg456.jpg);height: 50%;background-repeat: no-repeat;background-position: center;background-size: cover;">
    <div id="app" >
