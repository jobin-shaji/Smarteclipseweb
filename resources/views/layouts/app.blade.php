...
<body  style="background-image: url({{ url('/') }}/assets/images/loginbg123.jpg);height: 100%;background-repeat: no-repeat;background-position: center;background-size: cover;">
    <div id="app" >
