...
<div class="invoice-container">
  <div class="header">
  <img src="data:image/png;base64,{{ base64_encode(file_get_contents('images/vst.jpg')) }}" class="image img-thumbnail" height="50px" width="50px" />
<!-- <img src="https://smarteclipse.com/images/vst.jpg" width="50" alt="">--><br>
    <h1>Tax Invoice</h1>
