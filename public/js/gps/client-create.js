    ...
    //for username  and mobile value same
      ...
      $("#mobile_number").keyup(function(){
        $("#Username").val(this.value);
            var name=$('#name').val();
            var last_two_char_name      =       name.substr(name.length - 2);
            var name_to_lower           =       last_two_char_name.toLowerCase(last_two_char_name);
            var mobile_number           =       $('#mobile_number').val();
            var last_four_mobile        =       mobile_number.slice(-4);  
