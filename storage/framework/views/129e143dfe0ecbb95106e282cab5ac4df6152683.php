...
<section class="hilite-content">
     ...
     <form  method="POST" action="<?php echo e(route('crew.create.p')); ?>">
      ...
      <div class="row">
          <div class="col-md-6">
            <div class="form-group has-feedback">
              ...
              <input type="text" class="form-control <?php echo e($errors->has('name') ? ' has-error' : ''); ?>" placeholder="Crew Name" name="name" value="<?php echo e(old('name')); ?>" required> 
