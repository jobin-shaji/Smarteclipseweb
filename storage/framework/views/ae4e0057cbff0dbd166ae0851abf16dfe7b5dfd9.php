    ...
    <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group has-feedback">
            ...
            <input type="text" class="form-control"  value="<?php echo e($toll_fee_slab->min_km); ?>" disabled> 
          </div>

          <div class="form-group has-feedback">
            <label>Maximum Km</label>
            <input type="text" class="form-control"  value="<?php echo e($toll_fee_slab->max_km); ?>" disabled> 
          </div>
