     ...
     <form  method="POST" action="<?php echo e(route('tollfee-slab.create.p')); ?>">
      ...
      <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group has-feedback">
                <label class="srequired">Minimum KM</label>
                <input type="text" class="form-control <?php echo e($errors->has('min_km') ? ' has-error' : ''); ?>" placeholder="Minimum KM" name="min_km" value="<?php echo e(old('min_km')); ?>" required> 
                <span class="glyphicon glyphicon-list-alt form-control-feedback"></span>
              </div>
              <?php if($errors->has('min_km')): ?>
                <span class="help-block">
                    <strong class="error-text"><?php echo e($errors->first('min_km')); ?></strong>
                </span>
              <?php endif; ?>

              <div class="form-group has-feedback">
                <label class="srequired">Maximum KM</label>
                <input type="text" class="form-control <?php echo e($errors->has('max_km') ? ' has-error' : ''); ?>" placeholder="Maximum Limit" name="max_km" value="<?php echo e(old('max_km')); ?>" required> 
                <span class="glyphicon glyphicon-list-alt form-control-feedback"></span>
              </div>
              <?php if($errors->has('max_km')): ?>
                <span class="help-block">
                    <strong class="error-text"><?php echo e($errors->first('max_km')); ?></strong>
                </span>
              <?php endif; ?>
