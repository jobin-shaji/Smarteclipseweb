                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-lg-7  download_btn download-button-visibility">
                                                        <button class="btn btn download_button_view "  ><i class='fa fa-download'></i>
                                                            <a href="device-online-report-downloads?type=pdf&device_status={{$device_status}}&vehicle_status={{$vehicle_status}}&search=" class="online_device_download" onclick="return confirmDeviceStatusReportDownload();" style="color:white">Download Report</a>
                                                        </button>
                                                    </div>
                                                    <!-- /download button -->
                                                </div>
