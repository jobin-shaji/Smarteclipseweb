...
Route::group(['middleware' => ['web','auth','role:client'] , 'namespace' => 'App\Modules\Geofence\Controllers' ] , function() {
	...
	Route::get('/geofence/{id}/edit','GeofenceController@fenceEdit')->name('geofence.edit');
	Route::post('edit/fence','GeofenceController@updateFence');
	...
	Route::post('/geofence-assigned/delete','GeofenceController@deleteAssignedGeofence')->name('geofence.assigned.delete');
