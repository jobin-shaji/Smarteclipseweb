...
@section('title')
   Special classs bus Schedule Report
@endsection
@section('content')
<div class="page-wrapper page-wrapper-root page-wrapper_new">
  <div class="page-wrapper-root1">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Special classs bus Schedule Report</li>
          <b>Bus Schedule for Special classs Report</b>
       </ol>         
    </nav>  
