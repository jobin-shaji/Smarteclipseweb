...
class DealerController extends Controller {
    ...
    public function getDealers()
    {
        ...
        ->addIndexColumn()
        ->addColumn('user.mobile', function ($dealers) {
            if($dealers->user!=null ){  
                return $dealers->user->mobile;
            }
        })
        ->addColumn('user.email', function ($dealers) {
            if($dealers->user!=null ){  
                return $dealers->user->email;
            }
        })
        ->addColumn('working_status', function ($dealers) {
            if($dealers->user!=null && $dealers->user->deleted_at ==null){ 
            return "
