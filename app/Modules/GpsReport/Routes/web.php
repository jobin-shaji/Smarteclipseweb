...
Route::group(['middleware' => ['web','auth','role:root|dealer|sub_dealer|trader|sales'] , 'namespace' => 'App\Modules\GpsReport\Controllers' ] , function() {	
    ...
    Route::get('/esim-renewal-pending','GpsReportController@gpsRenewalPending')->name('esim-renewal-pending');
    Route::post('/esim-pending-list','GpsReportController@renewallist')->name('esim-pending-list');
    Route::post('/assign-single-device','GpsReportController@assignSingleDevice')->name('assign-single-device');
    
    
    //GPS DAILY RENEWAL REPORT
    Route::get('/gps-renewal-daily-report','GpsReportController@gpsrenewaldailyreport')->name('gps-renewal-daily-report');
    Route::get('/gps-renewal-daily-report/export','GpsReportController@gpsRenewalExport')->name('gps-renewal-daily-report.export');
