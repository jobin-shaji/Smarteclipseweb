...
Route::group(['middleware' => ['web','auth','role:root|sub_dealer|client|trader|Call_Center'] , 'namespace' => 'App\Modules\Complaint\Controllers' ] , function() {	
...
Route::group(['middleware' => ['web','auth','role:client|Call_Center'] , 'namespace' => 'App\Modules\Complaint\Controllers' ] , function() {
...
Route::group(['middleware' => ['web','auth','role:root|sub_dealer|trader'] , 'namespace' => 'App\Modules\Complaint\Controllers' ] , function() {	
...
Route::group(['middleware' => ['web','auth','role:servicer|root|sub_dealer|trader'] , 'namespace' => 'App\Modules\Complaint\Controllers' ] , function() {
