      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body wizard-content">
            <form  method="POST" action="{{route('sub.dealers.updateSales.p',$user->id)}}">
              {{csrf_field()}}
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group row" style="float:none!important">
                        <label class="col-sm-3 text-right control-label col-form-label">Sales</label>
                        <select required class="form-control {{ $errors->has('sales_id') ? ' has-error' : '' }}"  name="sales_id" id="sales_id" value="{{ $user->sales_id }}" required>
                      <option value="" name="sales_id" selected="selected" disabled="disabled">Select Sales Person</option>
                ...
                <div class="col-md-1 ">
                <button type="submit" class="btn btn-primary btn-md form-btn">Assign to Sales</button>
              </div>
              </div>
            </form>
          </div>
