...
class SubDealer extends Model
{
  use SoftDeletes;    
	protected $fillable=[
		'user_id','dealer_id','sales_id','name','address','status','created_by','deleted_by','deleted_at'
	];	
  ...
  {
    return $this->belongsTo('App\Modules\Sales\Models\Salesman','sales_id','id')->withTrashed();
  }
