...
Route::group(['middleware' => ['web','auth','role:dealer|root'] , 'namespace' => 'App\Modules\SubDealer\Controllers' ] , function() {
// //for dealers
...
Route::get('/sub-dealers/{id}/assign_sales','SubDealerController@assignSales')->name('sub.dealers.assignSales');
Route::post('/sub-dealers/{id}/assign_sales','SubDealerController@updateSales')->name('sub.dealers.updateSales.p');
