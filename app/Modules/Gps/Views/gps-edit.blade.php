                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group has-feedback">
                      ...
                      <div class="form-group has-feedback">
                        <label class="srequired">Installation date(YYY-MM-DD)</label>
                        <input type="text" class="form-control {{ $errors->has('installation_date_new') ? ' has-error' : '' }}" placeholder="installation date" name="installation_date_new"  value="{{ $gps->installation_date_new}}"> 
                          @if ($errors->has('installation_date_new'))
                            <span class="help-block">
                              <strong class="error-text">{{ $errors->first('installation_date_new') }}</strong>
                            </span>
                          @endif
                      </div>  
                      <div class="form-group has-feedback">
                        <label class="srequired">Validity</label>
                        <input type="text" class="form-control {{ $errors->has('validity') ? ' has-error' : '' }}" placeholder="Validity" name="validity"  value="{{ $gps->validity}}" min="0"> 
