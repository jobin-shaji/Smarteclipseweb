            ...
            <svg width="{{ $size }}" height="{{ $size }}" viewBox="0 0 {{ $size }} {{ $size }}" style="display:block;">
                @foreach($months as $i => $m)
                    @php
                        ...
                        // Label positioning - adjusted for wider slices
                    ...
                    <text x="{{ $dx }}" y="{{ $dy + 28 }}" text-anchor="middle" font-size="10" font-weight="800" fill="#28a745">
                        Renewed: {{ $m['renewed'] }}
                    </text>

                    <text x="{{ $dx }}" y="{{ $dy + 42 }}" text-anchor="middle" font-size="10" font-weight="800" fill="#dc3545">
