...
{  
    ...
    protected $fillable=['validity_date','installation_date_new','installation_date','valid_upto', 'provider1','provider2','serial_no','icc_id','icc_id1','e_sim_number1','validity','vehicle_no','imsi','imei','manufacturing_date','e_sim_number','batch_number','model_name','version','user_id','status','device_time','employee_code',
    
    'refurbished_status','amount','pay_method','pay_screen_shot','pay_status','renewed_by','pay_date','mob_app','plan_id','warrenty_certificate',
];
    ...
    public function employee(){
        return $this->hasOne('App\Modules\Employee\Models\Employee','code','employee_code')->withTrashed();
    }
   ...
   /*  return   $query = DB::table('gps_summery')
     ->leftJoin('gps_stocks', 'gps_summery.id', '=', 'gps_stocks.gps_id')
     ...
     ->orderBy('gps_summery.created_at', 'desc')
     ->select([
         'gps_summery.id',
         'gps_summery.serial_no',
         'gps_summery.imei',
         'gps_summery.imsi',
         'gps_summery.icc_id',
         'gps_summery.icc_id1',
         'gps_summery.e_sim_number1',
         'gps_summery.validity',
         'gps_summery.provider1',
         'gps_summery.provider2',
         'gps_summery.batch_number',
         'gps_summery.employee_code',
         'gps_summery.manufacturing_date',
         'gps_summery.e_sim_number',
         'gps_summery.model_name',
         'gps_summery.version',
         'gps_summery.deleted_at',
         'gps_summery.refurbished_status',
         'gps_summery.is_returned',
    ...
    public function getAllPendingDevicesList()
    {
       /* return self::select(
            'id',
            'serial_no',
     ...
     return   $query = DB::table('gps_summery')
     ->leftJoin('vehicles', 'gps_summery.id', '=', 'vehicles.gps_id')
     //->leftJoin('clients', 'clients.id', '=', 'vehicles.client_id')
   //  ->leftJoin('dealers', 'dealers.id', '=', 'gps_stocks.dealer_id')
     //->leftJoin('sub_dealers', 'sub_dealers.id', '=', 'gps_stocks.subdealer_id')
     ...
     ->select([
         ...
         'gps_summery.icc_id1',
         'gps_summery.e_sim_number1',
        'gps_summery.installation_date_new',
        'gps_summery.validity_date',
         ...
         'gps_summery.model_name',
         'gps_summery.version',
         'gps_summery.pay_status',
         'gps_summery.validity',
         'gps_summery.vehicle_no',
