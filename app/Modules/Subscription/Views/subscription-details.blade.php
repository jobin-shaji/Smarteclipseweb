        ...
        <div class="row">
          <div class="col-md-6 col-lg-6">
            <div class="form-group has-feedback">
              <label>Plan</label>
              <input type="text" class="form-control {{ $errors->has('plan_id') ? ' has-error' : '' }}" placeholder="Plan" name="name" value="{{ $subscription->name}}" disabled> 
            </div>

            <div class="form-group has-feedback">
              <label>Details</label>
              <textarea  id="editor" class="form-control editor-medium"  disabled> {{ $subscription->description}}</textarea>  
            </div>
            ...
            <div class="form-group has-feedback">
              <label>Year</label>
              <input type="text" class="form-control {{ $errors->has('year') ? ' has-error' : '' }}" placeholder="Year" name="year" value="{{ $subscription->year}}" disabled> 
            </div>
