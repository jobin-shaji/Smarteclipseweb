            ...
            {{csrf_field()}}
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  ...
                  <input type="text" class="form-control {{ $errors->has('plan_id') ? ' has-error' : '' }}" placeholder="Plan" name="name" value="{{ $subscription->name}}"> 
                  </div>
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control {{ $errors->has('amount') ? ' has-error' : '' }}" placeholder="Amount" name="year" value="{{ $subscription->year }}" required> 
                    @if ($errors->has('year'))
                      <span class="help-block">
