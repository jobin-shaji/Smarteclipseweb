...
class Vehicle extends Model
{
	...
	protected $fillable = [
        'name','register_number','gps_id','driver_id', 'vehicle_type_id', 'e_sim_number','status','client_id','servicer_job_id','engine_number','chassis_number','model_id','next_due_date',
        'inv_generated','installation_date','validity_date'
    ];
    ...
    */
    ...
    public function getVehicleListBasedOnClient($client_id)
    {
                    return self::select([
                      ...
                      'deleted_at',
                      'is_returned',
                      'inv_generated','next_due_date','validity_date','installation_date'
                  ])
                  ->withTrashed()
    ...
    public function getVehicleListBasedOnDriver($driverid)
    {
      return self::select(
                      'id',
                      'name',
