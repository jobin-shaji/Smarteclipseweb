...
use App\Modules\Sales\Models\Finance;
...
class FinanceController extends Controller {
    ...
    {
       return view('Sales::finance-create');
    }
    ...
    {
        return view('Sales::finance-list');
    }
    ...
    public function details(Request $request)
    {
        ...
        return view('Sales::finance-details',['Finance' => $finance,'user' => $user]);
    }
    public function edit(Request $request)
    {
        ...
        return view('Sales::finance-edit',['finance' => $finance,'user' => $user]);
    }
    ...
    public function changePassword(Request $request)
    {
        ...
        return view('Sales::finance-change-password',['finance' => $finance]);
    }
    //update password
