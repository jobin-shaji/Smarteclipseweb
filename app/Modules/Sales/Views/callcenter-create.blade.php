...
<div class="page-wrapper-root1">
   <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Create Call Center Man</li>
      <b>Add Call Center</b>
    </ol>
  ...
  <div class="card-body">
    <div class="table-responsive">
      <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">  <div class="row">
          <div class="col-sm-12">
            <form  method="POST" action="{{route('callcenter.create.p')}}">
            {{csrf_field()}}
              <div class="row">
                <div class="col-md-6">
                  ...
                  <?php
                    ...
                    if (strpos($url, $rayfleet_key) == true) {  ?>
                      <div class="form-group has-feedback">
                        ...
                        <input type="text" required pattern="[0-9]{10}" class="form-control {{ $errors->has('mobile_number') ? ' has-error' : '' }}" placeholder="Mobile Number" name="mobile_number" value="{{ old('mobile_number') }}" title="Mobile number should be exactly 11 digits"  maxlength="10"  /> 
                  ...
                  <?php } ?> 
                   ...
                   <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control {{ $errors->has('code') ? ' has-error' : '' }}" placeholder="Employee code" name="code" title='Employee code' required>
                    @if ($errors->has('code'))
                      <span class="help-block">
