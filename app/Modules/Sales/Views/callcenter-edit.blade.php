...
<div class="page-wrapper page-wrapper-root page-wrapper_new">
  <div class="page-wrapper-root1">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Update Finance Details</li>
        <b>Update Call centers Details</b>
      </ol>
    ...
    <div class="card-body">
      <div class="table-responsive">
        <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">  <div class="row">
            <div class="col-sm-12">
              <form  method="POST" action="{{route('callcenter.update.p',$user->id)}}">
              {{csrf_field()}}
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group has-feedback">
                      <label>Name</label>
                      <input type="text" class="form-control {{ $errors->has('name') ? ' has-error' : '' }}" placeholder="Name" name="name" maxlength = '50' required value="{{ $callcenters->name}}"> 
                      @if ($errors->has('name'))
                    ...
                    <div class="form-group has-feedback">
                      <label>Address</label>
                      <input type="text" class="form-control {{ $errors->has('address') ? ' has-error' : '' }}" placeholder="Address" name="address" value="{{$callcenters->address}}" readonly>
                    </div>
                  ...
                  <?php } ?>
                    ...
                    <input type="text" class="form-control {{ $errors->has('code') ? ' has-error' : '' }}" placeholder="Employee code" name="code"  value="{{ $callcenters->code}}" title='Employee code' required>
                    @if ($errors->has('code'))
                      <span class="help-block">
