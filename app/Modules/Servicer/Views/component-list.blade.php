...
<div class="page-wrapper_new">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Components List</li>
          <b>Components List</b>
      </ol>
    ...
    <script>
        ...
        $("#products_table").DataTable({
                ...
                columns: [
                    ...
                    {data: 'store_id', name: 'store_id', orderable: false },   
                    {data: 'product_id', name: 'product_id', orderable: false },   
                    {data: 'customer_order', name: 'customer_order', orderable: false },   
                             
                    {data: 'total', name: 'total', orderable: false,searchable: false},           
                    {data: 'gst_percent', name: 'gst_percent', orderable: false},
                    {data: 'stocks', name: 'stocks', orderable: false },  
