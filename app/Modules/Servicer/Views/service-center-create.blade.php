...
<section class="hilite-content">
  <div class="page-wrapper_new">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Create Service Center</li>
        <b>Create Service Center</b>
     </ol>
    ...
    <form  method="POST"  action="{{route('post-service-center')}}">
      {{csrf_field()}}
      <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body_vehicle wizard-content">   
                      <div class="form-group row" style="float:none!important">
                        <label  for="fname" class="col-sm-3 text-right control-label col-form-label">Service Center Name&nbsp<font color="red">*</font></label> 
