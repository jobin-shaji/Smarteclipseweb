  ...
  <div class="page-wrapper_new">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <b>Add New Components to Store</b>
     </ol>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row" style="float:none!important">
                        ...
                        <div class="form-group has-feedback">
                          <input type="text" id="assets_id"   class="form-control {{ $errors->has('assets_id') ? ' has-error' : '' }}" placeholder="assets" id="name" name="assets_id"  value="{{ old('assets_id') }}" required>
                      ...
                      <div class="form-group row" style="float:none!important">
                        ...
                        <div class="form-group has-feedback">
                          <input type="text" id="name"   class="form-control {{ $errors->has('name') ? ' has-error' : '' }}" placeholder="Name" id="name" name="name"  value="{{ old('name') }}" required>
                      ...
                      <div class="form-group row" style="float:none!important">
                        ...
                        <div class="form-group has-feedback">
                          <textarea class="form-control {{ $errors->has('description') ? ' has-error' : '' }}"  name="description" id="description"></textarea>
                        </div>
                      ...
                      <div class="form-group row" >
                        ...
                        <div class="form-group has-feedback">
                          <input type="text" class="form-control {{ $errors->has('price') ? ' has-error' : '' }}"  id="price" name="price" placeholder="Price" required>
                        </div>
                        @if ($errors->has('price'))
                          <span class="help-block">
                      ...
                      <div class="form-group row" >
                        ...
                        <div class="form-group has-feedback">
                          <input type="text" class="form-control {{ $errors->has('stocks') ? ' has-error' : '' }}"  id="stocks" name="stocks" placeholder="Stocks" required>
                        </div>
                      ...
                      <div class="form-group row" >
                        ...
                        <div class="form-group has-feedback">
                          <input type="text" class="form-control {{ $errors->has('min_quantity') ? ' has-error' : '' }}"  id="min_quantity" name="min_quantity" placeholder="Min Purchase Quantity" required>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                                ...
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">
                                    ...
                                    <div class="form-group has-feedback">
                                    <input type="text" class="form-control" id="customer_order" name="customer_order" placeholder="Customer Order">
                                    </div>
                                    </div> 
