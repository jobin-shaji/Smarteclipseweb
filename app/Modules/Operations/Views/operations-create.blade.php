...
<div class="page-wrapper-root1">
   <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Add Service Center Technician</li>
      <b>Add Service Center Technician</b>
    </ol>
  ...
  <div class="card-body">
    <div class="table-responsive">
      <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">  <div class="row">
          <div class="col-sm-12">
            <form  method="POST" action="{{route('operations.create.p')}}">
            {{csrf_field()}}
            <div class="row">
            <div class="col-md-6">
            <div class="form-group" >
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Branch&nbsp<font color="red">*</font></label>
                        <div class="form-group ">
                          <select class="form-control  select2 {{ $errors->has('service_center_id') ? ' has-error' : '' }}" id="service_center_id" name="service_center_id" required>
                          <option  value="" selected disabled>Select Branch</option>
                          @foreach($service as $country)
                        ...
                        @if ($errors->has('service_center_id'))
                          <span class="help-block">
                            <strong class="error-text">{{ $errors->first('service_center_id') }}</strong>
                          </span>
                        @endif
                      </div>
                      </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control {{ $errors->has('address') ? ' has-error' : '' }}" placeholder="Address" name="address"  id="address" value="{{ old('address') }}" maxlength='150' required autocomplete="off"> 
                ...
                <div class="col-md-6">
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control {{ $errors->has('username') ? ' has-error' : '' }}" placeholder="Username" name="username" value="{{ old('username') }}" maxlength='50' required autocomplete="off" >
...
$(document).ready(function() {
    $('#service_center_id').on('change', function() {
