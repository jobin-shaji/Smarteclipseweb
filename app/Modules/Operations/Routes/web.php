...
Route::post('/operations/get-center-address','OperationsController@getAddress')->name('get-center-address');

// store keeper


Route::get('/store-keeper','OperationsController@storekeeperListPage')->name('store-keeper');
Route::get('/store-keeper-list','OperationsController@getStoreKeeper')->name('storekeeper-list');
Route::get('/storekeeper/create','OperationsController@createStoreKeeper')->name('storekeeper.create');
Route::post('/storekeeper/create','OperationsController@saveStoreKeeper')->name('storekeeper.create.p');

Route::get('/storekeeper/{id}/change-password','OperationsController@changeStoreKeeperPassword')->name('storekeeper.change-password');
	//Route::post('/storekeeper/{id}/update-password','OperationsController@updateStoreKeeperPassword')->name('storekeeper.update-password.p'); 
