          ...
          <div class="row">
              ...
              <div class="col-md-6">
                  <div class="form-group" >
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Department&nbsp<font color="red">*</font></label>
                        <div class="form-group ">
                          <select class="form-control  select2 {{ $errors->has('department_id') ? ' has-error' : '' }}" id="department_id" name="department_id" required>
                        ...
                        @if ($errors->has('department_id'))
                          <span class="help-block">
                            <strong class="error-text">{{ $errors->first('department_id') }}</strong>
                          </span>
                        @endif
                      </div>
                      </div>
              ...
              <div class="col-md-6">
                  <div class="form-group" >
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Designations &nbsp<font color="red">*</font></label>
                        <div class="form-group ">
                          <select class="form-control  select2 {{ $errors->has('designation') ? ' has-error' : '' }}" id="designation_id" name="designation_id" required>
                          <option  value="" selected disabled>Select Designations</option>
                          @foreach($designation as $country)
                            <option value="{{$country->id}}" >{{$country->name}}</option>  
                          @endforeach
