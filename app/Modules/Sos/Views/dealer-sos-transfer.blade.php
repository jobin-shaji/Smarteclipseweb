  ...
  <nav aria-label="breadcrumb">
    ...
    <div class="card-body">
      <section class="hilite-content">
        <form  method="POST" action="{{route('sos-transfer-dealer.transfer.p')}}">
                {{csrf_field()}}
              <div class="row">
                <div class="col-md-12 col-lg-6">
                  <div class="form-group has-feedback">
                      ...
                      <select class="form-control select2 subDealerData" id="to_user" name="sub_dealer_user_id" data-live-search="true" title="Select Sub Dealer" required>
                        ...
                        <option value="{{$entity->user_id}}">{{$entity->name}}</option>
                        @endforeach
                      </select>    
                  ...
                  <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control {{ $errors->has('invoice_number') ? ' has-error' : '' }}" placeholder="Invoice Number" name="invoice_number" pattern="[A-Za-z0-9]+" title="letters and numbers only, no punctuation or special characters" value="{{ old('invoice_number') }}" pattern="[A-Za-z0-9]+" title="letters and numbers only, no punctuation or special characters" autocomplete="off" required> 
