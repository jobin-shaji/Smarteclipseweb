...
.tblUserVehicles tr:hover:nth-child(even) {
    background-color: #c7ecee; /* Light blue on hover */
}
.tblUserVehicles tr:hover:nth-child(odd) {
    background-color: #a9cce3; /* Light blue on hover */
}
...
<style>
 /* Custom styles for the InfoWindow */
 .gm-style-iw {
            padding: 3px !important; /* Adjust as needed */

        }

        /* Custom styles for the close button */
        .gm-style-iw-t::after {
            top: 0px !important; /* Adjust position if needed */
            right: 0px !important; /* Adjust position if needed */
            padding: 2px 5px !important; /* Adjust padding as needed */
        }
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="pageContainer" style="overflow: scroll">
      <div class="col-lg-12">
        <div class="st-actionContainer right-bottom" style="width:26%;">
          <div class="right-bottom">
          </div>

          <div class="right-bottom2 all_user_gps_data outer-container" style="width: 100%;background-color:#999!important;">
            {{--
            ...
            <div class="container vehListContianer">
...
<script>
  ...
  function GetDashVehiclesView() {
    ...
    var data = {'mode':'map','userid': @json(auth()->id())};
...
<script src="{{asset('js/gps/map-user-view.js')}}"></script>
