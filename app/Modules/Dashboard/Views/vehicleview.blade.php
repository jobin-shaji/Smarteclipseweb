<table class="tblUserVehicles">
  <tbody>
    <tr style="background-color: #ddd;cursor:default;">
      <th><i class="fa fa-refresh i.fa.fa-refresh refIcon" onclick="GetDashVehiclesView()" aria-hidden="true" style="color: blue;margin-left:-3px;margin-top:-2px;"></i></th>
      <th>Reg.No.</th>
      <th>IMEI</th>
    ...
    <tr title="{{$vehicle->updated_at}} ({{$timeFormat}} Hrs ago) {{$vehicle->lat}}" onclick="OnVehicleClicked('{{$vehicle->imei}}')">
    ...
    <tr style="background-color: #ddd;cursor:default;">
      <th colspan=10 style="font-style: italic;color:#999;font-weight:normal;text-align:left;padding-left:1em;margin-top:5px;font-size:small;">
        ...
        <i class="fa fa-plus-square-o i.fa.fa-plus-square-o" onclick="ShowAddNewPanel()" aria-hidden="true" style="float: right;color:red;font-size:1.5em;margin-top:3px;margin-right:0.4em;display:block;cursor:pointer;"></i>
        <div style="float: right;margin-right:0.8em;font-size:small;margin-top:5px;">Add Vehicle</div>

        <i class="fa fa-truck i.fa.fa-truck" onclick="ShowVehiclesPanel()" aria-hidden="true" style="float: right;color:yellow;font-size:1.5em;margin-top:3px;margin-right:0.4em;display:block;cursor:pointer;"></i>
        <div style="float: right;margin-right:0.8em;font-size:small;margin-top:5px;">Vehicles</div>
