  ...
  <div class="page-wrapper-root1">
    <section class="content">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  gps_dashboard_grid dash_grid" style="background-color: #d6270b!important">
          <div class="small-box bg-green bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  dealer_dashboard_grid dash_grid" style="background-color: #d46415!important">
          <div class="small-box bg-yellow bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  gps_dashboard_grid dash_grid" style="background-color: #0E9205!important">
          <div class="small-box bg-green bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  gps_dashboard_grid dash_grid" style="background-color: #013467!important">
          <div class="small-box bg-green bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  dealer_dashboard_grid dash_grid" style="background-color: #990299!important">
          <div class="small-box bg-yellow bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  gps_dashboard_grid dash_grid" style="background-color: #B2033B!important">
          <div class="small-box bg-green bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  gps_dashboard_grid dash_grid" style="background-color: #783802!important">
          <div class="small-box bg-green bxs">
            <div class="inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12  dealer_dashboard_grid dash_grid" style="background-color: #B2030B!important">
          <div class="small-box bg-yellow bxs">
            <div class="inner">
