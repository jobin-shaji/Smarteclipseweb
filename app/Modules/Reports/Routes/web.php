...
Route::group(['middleware' => ['web','auth','role:client|school|Driver'] , 'namespace' => 'App\Modules\Reports\Controllers' ] , function() {
	...
	Route::post('/alert-reports','AlertReportController@getAlertReport')->name('alert-reports');
