...
class ServicerJob extends Model
{
	 ...
	 protected $fillable = [
        'servicer_id', 'client_id','complaint_id','job_id','start_code','job_type','user_id','description','job_date','job_complete_date','status','latitude','longitude','gps_id','comment','location','role','job_status'
    ];
