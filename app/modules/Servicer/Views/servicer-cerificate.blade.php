        ...
        <div class="card-body">
          <div class="table-responsive">
              <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4" style=" background-color: white">
                ...
                <div style="width:800px; height:700px; padding:20px;  border: 10px solid #787878">
              
                  <div style="width:750px; height:650px; padding:20px;  border: 5px solid #787878">
                     <span style="font-size:10px; font-weight:bold; text-align:right;">SUB DEALER/OEM ICON</span>
                     <div style="text-align:right;">

                     <span style="font-size:10px; font-weight:bold; text-align:right;">ADDRESS WITH<<br>PHONE NUMBER AND MAIL ID</span>
                   </div>
                     <div style="text-align:center;">
                         ...
                         <span style="font-size:15px; font-weight:bold;text-align:center;">DATE:<br/>DOCUMENT NUMBER:
                         </span>
                       </div>
                         <div style="text-align:center;">
