                ...
                <div class="row">
                  <div class="col-sm-12">      
                    <div class="row">
                      <div class="col-xs-12">
                        <?php 
                         $encript=Crypt::encrypt($servicer_job->clients->id);
                         ?>
                        <a href="{{route('servicer.vehicles.create',$encript)}}">
                        <button class="btn btn-xs">Add Vehicle</button>
                      </a>
                      </div>
                    </div>
                    ...
                    <div class="form-group row" style="float:none!important">
                     ...
                     <div class="form-group row" style="float:none!important">
                      <label for="fname" class="col-sm-3 text-right control-label col-form-label">Job Complete Date</label>
                      <div class="form-group has-feedback">
