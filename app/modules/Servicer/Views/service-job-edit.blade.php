                    ...
                    <div class="card">
                      <div class="card-body">                                     
                        ...
                        <div class="form-group row" style="float:none!important">
                         ...
                         <div class="form-group row" style="float:none!important">
                           <label for="fname" class="col-sm-5 text-right control-label col-form-label">GPS Serial No</label>
                           <div class="form-group has-feedback">
                        ...
                        <div class="form-group row" style="float:none!important">
                         ...
                         <div class="form-group row" style="float:none!important">
                           <label for="fname" class="col-sm-5 text-right control-label col-form-label">Status</label>
                           <div class="form-group has-feedback">
                             <select class="form-control selectpicker" data-live-search="true" title="Select Servicer" id="gps_id" name="gps_id" required>
                                <option value="<?php if($servicer_job['status']==1){echo 'assigned';} else { echo 'pending'; } ?>"><?php if($servicer_job['status']==1){echo 'assigned';} else { echo 'pending'; } ?></option>
                              </select>                           
                           </div>
                           @if ($errors->has('gps_id'))
                           <span class="help-block">
