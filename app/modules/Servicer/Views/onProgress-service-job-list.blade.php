...
$key        = (isset($_GET['in_progress_service_search_key'])) ? $_GET['in_progress_service_search_key'] : '';
?>
  <div class="page-wrapper_new">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/In Progress Service Jobs List</li>
          <b> In progress  Service Jobs List</b>
      </ol>
    ...
    <div align="right" class="search-1">
      <form method="GET" action="{{route('inprogress.service.job.list')}}" class="search-top">
        {{csrf_field()}}
        ...
        @section('script')
          ...
          {
            document.getElementById('in_progress_service_search_key').value = '';
          }
