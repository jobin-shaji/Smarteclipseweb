...
@section('title')
  Completed Reinstallation Jobs List
@endsection
@section('content')
<?php
$perPage    = 10;
...
<div class="page-wrapper_new">
   <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Completed Reinstallation Jobs List</li>
            <b> Completed Reinstallation Jobs List</b>
        </ol>
    ...
    <div align="right" class="search-1">
        <form method="GET" action="{{route('reinstallation-job-history-list')}}" class="search-top">
        {{csrf_field()}}
