...
<section class="hilite-content">
  <div class="page-wrapper_new">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page"><a href="/home">Home</a>/Create Route Batch</li>
        <b>Add Route Batch</b>
     </ol>
    ...
    <form  method="POST" action="{{route('route-batch.create.p')}}">
      {{csrf_field()}}
      <div class="row">
                    ...
                    <div class="card-body_vehicle wizard-content">   
                      <div class="form-group row" style="float:none!important">
                        ...
                        <div class="form-group has-feedback">
                          <input type="text" class="form-control {{ $errors->has('name') ? ' has-error' : '' }}" placeholder="Batch Name" name="name" value="{{ old('name') }}" > 
                        </div>
                        @if ($errors->has('name'))
