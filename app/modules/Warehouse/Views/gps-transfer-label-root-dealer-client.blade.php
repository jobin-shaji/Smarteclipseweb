          ...
          <div class="row"> 
            <div class="col-md-12"> 
              <span style="float:left;width:28%">
                ...
                <a href="{{route('gps-transfer-label-root-dealer-client.export',$gps_transfer->id)}}">
                  <button style="float:left;margin-left:19%;" type="button" class="btn btn-primary btn-md form-btn">Download</button>
                </a>
