                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row" style="float:none!important">
                       ...
                       <div class="form-group row" style="float:none!important">
                        ...
                        <div class="form-group has-feedback">
                          <select class="form-control select2 dealerData" id="trader" name="trader" data-live-search="true" title="Select Sub Dealer">
...
@section('script')
 ...
 <script async defer
 src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCXmg0OWU4PM-pEIJPr_GpJAG9dKUHgim4&libraries=places&callback=initMap"></script>
