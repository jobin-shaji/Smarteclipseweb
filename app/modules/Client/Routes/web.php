...
Route::group(['middleware' => ['web','auth','role:sub_dealer'] , 'namespace' => 'App\Modules\Client\Controllers' ] , function() {
	...
	Route::get('/client/{id}/change-password-subdealer','ClientController@changePassword')->name('client.change-password-subdealer');
	Route::post('/client/{id}/update-password-subdealer','ClientController@updatePassword')->name('client.update-password.subdealer'); 
