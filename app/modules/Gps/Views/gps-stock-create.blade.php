  ...
  <div class="page-wrapper_new">
    ...
    <form  method="POST" action="{{route('gps.stock.p')}}">
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">Serial No</label>
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">IMEI</label>
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">Model Name</label>
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">Manufacturing Date</label>
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">ICC ID</label>
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">Batch Number</label>
      ...
      <div class="form-group">
        <label class="srequired" style="padding: 1% 3% 1% 2%;">Employee Code</label>
      ...
      <div class="form-group">
        <label class="srequired " style="padding: 1% 3% 1% 2%;">IMSI</label>
      ...
      <div class="form-group">
        <label class="srequired " style="padding: 1% 3% 1% 2%;">Version</label>
