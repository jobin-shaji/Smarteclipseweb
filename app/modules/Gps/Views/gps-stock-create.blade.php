                  ...
                  <div class="col-md-6">
                    <div class="card-body_vehicle wizard-content">   
                      ...
                      <div class="form-group has-feedback">
                        ...
                        manufacturing_date form-control {{ $errors->has('manufacturing_date') ? ' has-error' : '' }}" placeholder="Manufacturing Date" name="manufacturing_date" value="{{ old('manufacturing_date') }}" required readonly="readonly"> 
                  ...
                  <div class="col-md-6">
                    <div class="card-body_vehicle wizard-content"> 
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <input type="number" class="form-control {{ $errors->has('e_sim_number') ? ' has-error' : '' }}" placeholder="E-SIM Number" id="e_sim_number" name="e_sim_number" required readonly="readonly">
