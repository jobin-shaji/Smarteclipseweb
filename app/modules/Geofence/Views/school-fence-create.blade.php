      ...
      <div class="page-breadcrumb route_breadcumb">
         <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div style="float:left!important">
                  <div class="form-group">  
                     <button class="btn btn-xs btn-info form-control" id="savebutton" style="background-color: green"> <i class="fa fa-filter" style="height:23px; background-color: green"></i> SAVE FENCE</button>
                     </div>
                  </div>
                     <div style="float:left!important">
                  <div class="form-group">  
...
@section('script')
<script src="{{asset('js/gps/school-geofence.js')}}"></script>
