...
<html lang="en">
    ...
    <body data-background-color="dark">
        ...
        <script src="{{asset('playback_assets/assets/js/core/jquery.3.2.1.min.js')}}">
        </script>
        ...
        <!-- Chart JS -->
        <script src="{{asset('playback_assets/assets/js/plugin/chart.js/chart.min.js')}}">
        </script>
        <!-- jQuery Sparkline -->
        <script src="{{asset('playback_assets/assets/js/jquery.sparkline.min.js')}}">
        </script>
        <!-- Chart Circle -->
