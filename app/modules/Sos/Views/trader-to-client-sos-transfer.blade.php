  ...
  <nav aria-label="breadcrumb">
    ...
    <div class="card-body">
      <section class="hilite-content">
        <form  method="POST" action="{{route('sos-transfer-trader-to-client.transfer.p')}}">
                {{csrf_field()}}
              <div class="row">
                <div class="col-md-12 col-lg-6">
                  <div class="form-group has-feedback">
                      <label class="srequired">Client Name</label>
                      <select class="form-control select2 traderToClientData" id="to_user" name="client_user_id" data-live-search="true" title="Select Client" required>
