          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control {{ $errors->has('serial_no') ? ' has-error' : '' }}" placeholder="Serial NO" name="serial_no" value="{{ old('serial_no') }}" maxlength='20' required> 
              ...
              <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control {{ $errors->has('model_name') ? ' has-error' : '' }}" placeholder="Model Name" name="model_name" value="{{ old('model_name') }}" maxlength='50' required>   
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control {{ $errors->has('brand') ? ' has-error' : '' }}" placeholder="Brand" name="brand" value="{{ old('brand') }}" maxlength='50' required> 
                  @if ($errors->has('brand'))
                    <span class="help-block">
              ...
              <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control {{ $errors->has('version') ? ' has-error' : '' }}" placeholder="Version" name="version" value="{{ old('version') }}" maxlength='50' required> 
