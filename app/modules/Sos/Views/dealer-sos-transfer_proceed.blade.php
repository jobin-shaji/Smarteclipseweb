...
<form  method="POST" action="{{route('sos-transfer-dealer-proceed.create.p')}}">
        {{csrf_field()}}
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="row">
               ...
               @foreach  ($devices as $device )
                <div class="col-md-3">
                    <input type="checkbox" checked id="selectedCheckBox" name="sos_id[]" value="{{$device->id}}">{{$device->imei}}
                </div>
              @endforeach
      ...
      <div class="row">
        ...
        <div class="col-md-1 ">
          <a href="{{ route('sos-transfer-dealer.create') }}">
