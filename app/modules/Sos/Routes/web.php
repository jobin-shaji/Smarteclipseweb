...
Route::group(['middleware' => ['web','auth','role:sub_dealer'] , 'namespace' => 'App\Modules\Sos\Controllers' ] , function() {
    ...
    //SOS TRANSFER from sub dealer to client
    ...
    //SOS TRANSFER from sub dealer to trader
    Route::get('/sos-transfer-sub-dealer-to-trader/create','SosController@createSubDealerToTraderSosTransfer')->name('sos-transfer-sub-dealer-to-trader.create');
    Route::post('/sos-transfer-sub-dealer-to-trader-dropdown','SosController@getClientDetailsForSubDealer')->name('sos-transfer-sub-dealer-to-trader-dropdown');
    Route::post('/sos-transfer-sub-dealer-to-trader','SosController@proceedSubDealerToTraderSosTransfer')->name('sos-transfer-sub-dealer-to-trader.transfer.p');
    Route::post('/sos-transfer-sub-dealer-to-trader-proceed','SosController@proceedConfirmSubDealerToTraderSosTransfer')->name('sos-transfer-sub-dealer-to-trader-proceed.create.p');

    //transferred sos box label for sub dealer to trader
...
Route::group(['middleware' => ['web','auth','role:trader'] , 'namespace' => 'App\Modules\Sos\Controllers' ] , function() {
    ...
    Route::get('/sos-transfer-trader-to-end-user/create','SosController@createTraderToClientSosTransfer')->name('sos-transfer-trader-to-end-user.create');
    Route::post('/sos-transfer-trader-to-end-user-dropdown','SosController@getClientDetailsForTraderToClientTransfer')->name('sos-transfer-trader-to-end-user-dropdown');
    Route::post('/sos-transfer-trader-to-end-user','SosController@proceedTraderToClientSosTransfer')->name('sos-transfer-trader-to-end-user.transfer.p');
    Route::post('/sos-transfer-trader-to-end-user-proceed','SosController@proceedConfirmTraderToClientSosTransfer')->name('sos-transfer-trader-to-end-user-proceed.create.p');
});
...
Route::group(['middleware' => ['web','auth','role:root|dealer|sub_dealer|trader|client'] , 'namespace' => 'App\Modules\Sos\Controllers' ] , function() {
