...
class OverSpeedReportController extends Controller
{
    ...
    */
    public function getAlertsFromMicroService($request)
    {
        ...
        $filter         = [ 'user_id' => $request->user_id, 'alert_type' => self::ALERT_TYPE_OVERSPEED , 'vehicle_id' => $request->vehicle_id , 'start_date' => $request->start_date , 'end_date' => $request->end_date ,'limit' => 10000 ]; 
