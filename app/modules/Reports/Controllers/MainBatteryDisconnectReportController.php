...
class MainBatteryDisconnectReportController extends Controller
{
    ...
    public function export(Request $request)
    {
        ob_end_clean(); 
        ob_start();
        return Excel::download(new ExcelDocumentExport(['SL.No','Vehicle Name','Registration Number','Address','DateTime'],$this->getAlertsFromMicroService($request)), 'main-battery-disconnect-report-'.date('Ymdhis').'.xlsx');
    }
