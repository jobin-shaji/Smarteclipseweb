  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <b>  Accident Impact Alert Report</b>
      </div>
    </div>
  </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 pt-4">
                              <div class="form-group">          
                                ...
                                <button class="btn btn-sm btn1 btn-primary dwnld" id = 'accident_impact_alert_report_download' style = 'display:none;' onclick="downloadAccidentImpactAlertReport()">
