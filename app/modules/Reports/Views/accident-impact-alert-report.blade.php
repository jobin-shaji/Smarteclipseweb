                ...
                <div class="panel panel-default">
                  <div >
                    <div class="panel-body">
                      <form method="get" id = "form-accident-impact-report" action="{{route('alert-report-list')}}">
                        {{csrf_field()}}
                      ...
                      <table class="table table-hover table-bordered  table-striped accident-impact-report-table" id="accident-impact-report-table" style="width:100%;text-align: center;display:none" >
                        <thead>
                      ...
                      <div class="row float-right">
                        <div class="col-md-12 " id="accident-impact-report-pagination">
                        </div>
                      </div>
                    </div>
                  </div>
