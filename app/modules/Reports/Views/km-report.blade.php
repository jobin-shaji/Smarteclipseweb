                  ...
                  <div>
                    ...
                    <div class="col-md-12">                               
                      <div class="row">
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/sudden-accelaration.png" width="12%" height="60px" class="report_img"/>
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/geofence-entry.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/harsh-braking.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/geofence-exit.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/accident-impact.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/overspeed-entry.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/moving-duration.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/overspeed-exit.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/halt-duration.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/key.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/sleep-duration.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/zigzag-driving.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/ac.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/alerts.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
                        ...
                        <div class="widthh">
                          <div class="info-box">
                            <img src="{{ url('/') }}/SVG-Icons/main-battery-disconnect.png" width="12%" height="60px" class="report_img"/>
                            <div class="info-box-content">
