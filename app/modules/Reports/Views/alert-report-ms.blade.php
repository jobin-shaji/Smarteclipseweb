                  ...
                  <div class="panel panel-default">
                    <div >
                      <div class="panel-body">
                        <form method="get" id = "form-alert-report" action="{{route('alert-report-list')}}">
                          {{csrf_field()}}
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2">
                                  <div class="form-group">    
                                    ...
                                    <select class="form-control selectpicker" required style="width: 100%" data-live-search="true" title="Select Alert Type" id="alert_type" name="alert_type">
                                    <option value="" selected="selected" >Select</option>
                                    <option value="all">All</option>
                                    @foreach ($Alerts as $alert)
                                    <option value="{{$alert->code}}"   @if(isset($alertReports) && $alert->id==$alert_id){{"selected"}} @endif>{{$alert->description}}</option>
                                    @endforeach
                                    </select>
                                  </div>
                                </div>
                        ...
                        <div class="row float-right">
                          ...
                          <div class="col-md-12 " id="alert-report-pagination">
                          </div>
                        </div>
                      </div>
                    </div>
