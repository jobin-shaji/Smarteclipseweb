                      ...
                      <div class="panel-heading">
                        <div class="cover_div_search">
                          ...
                          <div class="col-lg-3 col-md-3"> 
                            <div class="form-group">                    
                            <label>Date</label>
                            <input type="text" class="@if(\Auth::user()->hasRole('fundamental'))datepickerFundamental @elseif(\Auth::user()->hasRole('superior')) datepickerSuperior @elseif(\Auth::user()->hasRole('pro')) datepickerPro @else datepickerFreebies @endif form-control" id="date" name="date" onkeydown="return false">
                          </div>
                          </div>                    
...
@section('script')
  <link rel="stylesheet" href="{{asset('css/loader-1.css')}}">
    <script src="{{asset('js/gps/mode-duration-report.js')}}"></script>
@endsection
@endsection
