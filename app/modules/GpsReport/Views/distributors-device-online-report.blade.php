                                ...
                                <div class="panel panel-default">
                                    <div >
                                        <div class="panel-body">
                                            <form method="get" action="{{route('online-device-report')}}">
                                            {{csrf_field()}}
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 pt-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <a  href="online-device-report" class="btn btn-primary">Clear</a>
                                        ...
                                        @if(count($device_online_report) != 0)
                                            <form method="GET" action="{{route('online-device-report')}}" class="search-top">
                                                {{csrf_field()}}
                                                <!-- filter section -->
                                                <div class="row ">
                                                    <!-- search -->
...
@section('script')
    ...
    $('#search').on('keyup',function(){
        ...
        $.ajax({
            type : 'get',
            url : '{{URL::to('online-device-search')}}',
            data:{
                'search':$value,
            ...
            success:function(data){
                ...
                $("a.online_device_download").attr('href', function(i,a){
                    $('a.online_device_download').attr("href", "online-device-report-downloads?type=pdf&device_status="+$device_status+"&vehicle_status="+$vehicle_status+"&search=" + $value);
                });
