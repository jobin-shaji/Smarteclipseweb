                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('device-offline-report-view', Crypt::encrypt($each_data->imei))}}" class='btn btn-xs btn-success' data-toggle='tooltip' title='View More Details'><i class='fa fa-eye'></i> View</a></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
