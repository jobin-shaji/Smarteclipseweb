                                ...
                                <div class="panel panel-default">
                                    <div >
                                        <div class="panel-body">
                                            <form method="get" action="{{route('offline-device-report')}}">
                                            {{csrf_field()}}
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 pt-4">  
                                                            <div class="form-group">                           
                                                                ...
                                                                <a  href="offline-device-report" class="btn btn-primary">Clear</a>
                                                            </div>
                                                        </div>          
                                                    </div>
                                                </div>
                                        ...
                                        @if(count($offline_devices) != 0)
                                            ...
                                            <form method="GET" action="{{route('offline-device-report')}}" class="search-top">
                                                {{csrf_field()}}
...
@section('script')
    ...
    <script type="text/javascript">
        $('#search').on('keyup',function(){
            ...
            $.ajax({
                type : 'get',
                url : '{{URL::to('offline-device-search')}}',
                data:{
                    'search':$value,
                ...
                success:function(data){
                    ...
                    $("a.offline_device_download").attr('href', function(i,a){
                        $('a.offline_device_download').attr("href", "offline-device-report-downloads?type=pdf&device_type="+$device_type+"&offline_duration="+$offline_duration+"&search=" + $value);
                    });
