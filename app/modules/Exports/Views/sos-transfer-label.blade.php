  ...
  <tbody>
    <tr style="width:700px;border:solid 1px #222;border-width:0 0 1px 0; position:absolute;">
      ...
      <tr style="width:710px;border:solid 1px #222;border-width:0 0 1px 0;position:absolute;">
        ...
        <td style="margin:0 0 0 12px;width:250px;font-family:’Helvetica Bold’,Helvetica,’Arial Bold’,Arial,sans-serif;font-size:13px;font-weight:bolder;padding:12px 0 12px 12px;border:solid 1px #222;border-width:0 0 0 1px;">Scanned Employee Code:{{$sos_transfer->scanned_employee_code}}
        </td>
      </tr>

      <tr style="width:710px;border:solid 1px #222;border-width:0 0 1px 0;position:absolute;">
        <td style="margin:0 0 0 12px;width:250px;font-family:’Helvetica Bold’,Helvetica,’Arial Bold’,Arial,sans-serif;font-size:13px;font-weight:bolder;padding:12px 0 12px 12px;border:none;">Order Number:{{$sos_transfer->order_number}}
        </td>
        <td style="margin:0 0 0 12px;width:250px;font-family:’Helvetica Bold’,Helvetica,’Arial Bold’,Arial,sans-serif;font-size:13px;font-weight:bolder;padding:12px 0 12px 12px;border:solid 1px #222;border-width:0 0 0 1px;">Invoice Number:{{$sos_transfer->invoice_number}}
        </td>
      </tr>
