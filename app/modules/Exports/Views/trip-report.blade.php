...
<div>
  <div style="margin-top:5%!important;floar:left">
    ...
    <span style="width:50%;float:left"><p>{{$gps->vehicle->client->address}}Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the </p></span>
