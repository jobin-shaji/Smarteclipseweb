            ...
            <form onsubmit="return locationSearch();">
              <div class="col-lg-4">
                <div class="col-lg-8 col-md-12">
                  ...
                  <input type="hidden" class="form-control" name="points" id="locationLatLng" value="" required>
                  <input type="hidden" name="lat" id="lat" value="{{$driver_location->latitude}}" required>  
                  <input type="hidden"  name="lng" id="lng" value="{{$driver_location->longitude}}" required> 
                </div>
                <div class="col-lg-4 col-sm-12 cover_search_button_route">
...
@section('script')
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key={{Config::get('eclipse.keys.googleMap')}}&libraries=drawing,places&callback=initMap"
       async defer></script>
@endsection
 @endsection