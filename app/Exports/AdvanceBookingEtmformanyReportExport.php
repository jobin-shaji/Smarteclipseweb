...
class AdvanceBookingEtmformanyReportExport implements FromView
{

	protected $AdvanceBookingEtmformanyReportExport;
 ...
 $closed_waybills = Waybill::select(
      ...
      foreach($closed_waybills as $waybill){
        ...
        $this->AdvanceBookingEtmformanyReportExport = $query->get();
	...
	{
	    return view('Exports::advance-booking-etm-formanydays-report', [
	        'AdvanceBookingEtmformanyReportExport' => $this->AdvanceBookingEtmformanyReportExport
	    ]);
	}
