...
class SinglestateReportExport implements FromView
{
	protected $SinglestateReportExport;
	public function __construct($depot,$state,$from,$to)
    {
      ...
      $waybill_etm =Waybill::select(
        ...
        $this->SinglestateReportExport = $query->get();
    } 
    public function view(): View
	{
	    return view('Exports::single-state-report', [
	        'SinglestateReportExport' => $this->SinglestateReportExport
	    ]);
	}    
}
