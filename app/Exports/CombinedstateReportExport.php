...
class CombinedstateReportExport implements FromView
{
	protected $CombinedstateReportExport;
	public function __construct($depot,$from,$to)
    {
       ...
       $waybill_etm =Waybill::select(
        ...
        $this->CombinedstateReportExport = $query->get();
    } 
    public function view(): View
	{
	    return view('Exports::combined-state-report', [
	        'CombinedstateReportExport' => $this->CombinedstateReportExport
	    ]);
	}    
}
